...
class World(object):
    ...
    def getDescriptionText(self):
        """ This method gets the description text from the room at the player's current location
            ReturnType String """
        coords = self._player.getCoords()
        return self.rooms['{}'.format(coords)]
    ...
    def getMenuOptions(self):
        ...
        options = ["Move north", "Pick up revolver", "Question bar patron", "Beat up pixie"]
        options.append(["Inventory", "Save and exit"])
        return options
