...
class Brownie(Enemy):
    def __init__(self):
        super(Brownie, self).__init__(name="Brownie", hp=10, dmg=2, enemyType=EnemyType.BROWNIE)

# Drow is a dark elf with magic and bludgeoning attacks. They have low hit
# points and high armor
class Drow(Enemy):
    def __init__(self):
        super(Drow, self).__init__(name="Drow", hp=35, dmg=2, enemyType=EnemyType.DROW)

# Goblin has knife/sword attacks. The have medium hit points
# and low armor
class Goblin(Enemy):
    def __init__(self):
        super(Goblin, self).__init__(name="Goblin", hp=20, dmg=15, enemyType=EnemyType.GOBLIN)

# Thug has bludgeoning or knife/sword attacks. They have medium hit points
# and medium armor
class Thug(Enemy):
    def __init__(self):
        super(Thug, self).__init__(name="Thug", hp=25, dmg=15, enemyType=EnemyType.THUG)
...
class Demon(Enemy):
    def __init__(self):
        super(Demon, self).__init__(name="Demon", hp=75, dmg=20, enemyType=EnemyType.DEMON)
